...
3.  **Set up environment variables**
    Copy the `.env.example` file to `.env` in the `backend` directory and fill in your API keys and database URLs.
...
4.  **Set up the database**
    Run Prisma migrations to create your database schema and generate the Prisma Client.
    ```bash
